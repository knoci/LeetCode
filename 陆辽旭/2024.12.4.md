...
[2056. 棋盘上有效移动组合的数目 - 力扣（LeetCode）](https://leetcode.cn/problems/number-of-valid-move-combinations-on-chessboard/description/)

![image-20241204185700440](https://gitee.com/knoci/picture/raw/master/image-20241204185700440.png)

​	想了30分钟，没有什么好的思路，就直接cv了，cv的答案是记录每个妻子的合法移动状态，然后dfs加双重for循环枚举棋子重复的非法状态
